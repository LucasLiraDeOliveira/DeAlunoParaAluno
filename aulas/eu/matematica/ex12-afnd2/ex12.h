...
{
    short int f; /* representará o número do estado final */
    struct fstate *proxf;
}fstate_t;
...
void ex12_init(void);  /**< Initializes some operations before start */
void ex12_update(void); /**< Updates values during program cycle */
